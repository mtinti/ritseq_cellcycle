...
3 outputs file
_F.bam  -> Pair reads containing the barcode in forward orientation
_R.bam  -> Pair reads containing the barcode in reverse complement orientation
_WT.bam -> Pair reads without barcode


If the fourth argument == True:
F and R outputs are merged, the merge file is sorted by reference and indexed
the starts file are removed.
2 outputs file
...
tot=0
#this dictionary will contains the read name
#mapped to barcode sequence orientation (F,R,FR,RR)
#ie
#{'NS500650:153:HN2TFBGXY:1:21107:18060:9750':'F'}
#this mapping is used to write the read to the 
#correct output bam file
done = {}

#transform the Bio Seq object back to string
